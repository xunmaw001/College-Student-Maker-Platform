	...
	<div class="addEdit-block" :style='{"padding":"10px 30px"}' style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' class="upload" v-if="type!='info'&& !ro.jietidabian" label="结题答辩" prop="jietidabian">
					<file-upload
						tip="点击上传结题答辩"
						action="file/upload"
						:limit="1"
				...
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else-if="ruleForm.jietidabian" label="结题答辩" prop="jietidabian">
					<el-button :style='{"border":"1px solid #2adbcb","cursor":"pointer","padding":"0 24px","margin":"0 20px 0 0","outline":"none","color":"#2adbcb","borderRadius":"0px","background":"#f1fcfb","width":"auto","lineHeight":"36px","fontSize":"14px","height":"36px"}' type="text" size="small" @click="download($base.url+ruleForm.jietidabian)">下载</el-button>
				</el-form-item>
				<el-form-item :style='{"margin":"0 0 30px 0","flexWrap":"wrap","textAlign":"left","background":"none","display":"block","width":"100%","justifyContent":"flex-start"}' v-else-if="!ruleForm.jietidabian" label="结题答辩" prop="jietidabian">
